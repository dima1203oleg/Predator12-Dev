...
# Metrics
TASKS_COUNTER = Counter('ingestagent_tasks_total', 'Total tasks processed')
HEALTH_GAUGE = Gauge('ingestagent_health', 'Agent health status')

class IngestAgent:
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        self.running = False
        self.agent_name = "IngestAgent"
        self.port = 9010
        self.role = "File/stream ingestion with AI-powered profiling and PII scanning"
