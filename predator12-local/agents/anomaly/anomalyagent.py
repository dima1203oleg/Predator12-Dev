...
# Metrics
TASKS_COUNTER = Counter('anomalyagent_tasks_total', 'Total tasks processed')
HEALTH_GAUGE = Gauge('anomalyagent_health', 'Agent health status')
...
class AnomalyAgent:
    def __init__(self):
        ...
        self.port = 9020
        self.role = "AI-enhanced anomaly detection with multi-model consensus"
