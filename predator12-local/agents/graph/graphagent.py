...
# Metrics
TASKS_COUNTER = Counter('graphagent_tasks_total', 'Total tasks processed')
HEALTH_GAUGE = Gauge('graphagent_health', 'Agent health status')

class GraphAgent:
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        self.running = False
        self.agent_name = "GraphAgent"
        self.port = 9022
        self.role = "Advanced graph analytics with AI-powered insights"
