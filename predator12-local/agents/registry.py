...
class AgentRegistry:
    ...
    def _create_default_registry(self):
        ...
        self_heal_agents = [
            ...
            },
            {
                ...
                "config_schema": {"graceful_shutdown_timeout": {"type": "int", "default": 30}},
            },
            {
                ...
                "config_schema": {"auto_install_missing": {"type": "bool", "default": False}},
            },
        ]
        ...
        optimize_agents = [
            {
                ...
                "config_schema": {"optimization_target": {"type": "str", "default": "latency"}},
            },
            {
                ...
                "config_schema": {"max_cpu_utilization": {"type": "float", "default": 0.8}},
            },
        ]
    ...
    def _determine_agent_type(self, agent_class: Type[BaseAgent]) -> str:
        ...
        if "self_heal" in module_name or any(
            ...
            return "self_heal"
        elif "optimize" in module_name or any(
            kw in class_name for kw in ["optimizer", "performance", "resource"]
        ):
            return "optimize"
        elif "modernize" in module_name or any(
            kw in class_name for kw in ["modernizer", "upgrade", "migrate"]
        ):
            return "modernize"
        else:
            return "general"
    ...
    def get_registry_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_updated": (
                max([a.registered_at for a in self.agents.values()]) if self.agents else None
            ),
        }
...
# Export main classes
__all__ = ["AgentRegistry", "ModelRegistry", "AgentRegistration", "ModelRegistration"]
