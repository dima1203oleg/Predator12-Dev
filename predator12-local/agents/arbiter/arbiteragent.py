...
# Metrics
TASKS_COUNTER = Counter('arbiteragent_tasks_total', 'Total tasks processed')
HEALTH_GAUGE = Gauge('arbiteragent_health', 'Agent health status')

class ArbiterAgent:
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        self.running = False
        self.agent_name = "ArbiterAgent"
        self.port = 9003
        self.role = "Arbitrates responses from multiple models/agents using FREE models"
