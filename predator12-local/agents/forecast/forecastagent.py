...
# Metrics
TASKS_COUNTER = Counter('forecastagent_tasks_total', 'Total tasks processed')
HEALTH_GAUGE = Gauge('forecastagent_health', 'Agent health status')
...
class ForecastAgent:
    def __init__(self):
        ...
        self.port = 9021
        self.role = "Advanced time series forecasting with ensemble methods"
