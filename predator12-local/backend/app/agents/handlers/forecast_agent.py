...
class ForecastAgent(BaseAgent):
    ...
    async def _make_forecast(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            forecast_dates = [
                (last_date + timedelta(days=i)).isoformat() for i in range(1, forecast_horizon + 1)
            ]
        ...
        try:
            ...
            return {
                ...
                "summary": {
                    ...
                    "dominant_trend": (
                        max(trend_counts, key=trend_counts.get) if trend_counts else "unknown"
                    ),
        ...
        try:
            ...
            return {
                ...
                "seasonality_metrics": {
                    ...
                    "trough_season": min(
                        range(len(seasonal_means)), key=lambda i: seasonal_means[i]
                    ),
                },
            }
    ...
    async def _anomaly_forecast(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            forecast_result = await self._make_forecast(
                {"model_id": model_id, "forecast_horizon": forecast_horizon}
            )
            ...
            return {
                ...
                "risk_summary": {
                    ...
                    "max_risk_period": max(
                        range(len(anomaly_probabilities)),
