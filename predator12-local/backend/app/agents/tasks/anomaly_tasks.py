...
def detect_anomalies_task(
    ...
    payload = {"dataset_id": dataset_id, "model_type": model_type, **kwargs}
...
def evaluate_anomaly_model_task(
    ...
    payload = {"model_id": model_id, "test_dataset_id": test_dataset_id, **kwargs}
...
def get_anomaly_scores_task(
    ...
    payload = {"model_id": model_id, "data_points": data_points, **kwargs}
