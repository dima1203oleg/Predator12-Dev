...
PRODUCTION_CONFIG = {
    "database": {"pool_size": 50, "max_overflow": 100},
    "api": {"workers": 4, "debug": False},
    "celery": {"worker_prefetch_multiplier": 4, "worker_max_tasks_per_child": 5000},
}

DEVELOPMENT_CONFIG = {
    "database": {"pool_size": 5, "max_overflow": 10},
    "api": {"workers": 1, "debug": True, "reload": True},
    "celery": {"worker_prefetch_multiplier": 1, "worker_max_tasks_per_child": 100},
}
