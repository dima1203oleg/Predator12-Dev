...
def generate_csv_report(self, report_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        self.update_state(state="PROGRESS", meta={"status": "Generating CSV file", "progress": 60})
        ...
        self.update_state(state="PROGRESS", meta={"status": "Uploading to MinIO", "progress": 80})
...
def generate_pdf_report(self, report_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        self.update_state(
            state="PROGRESS", meta={"status": "Creating PDF document", "progress": 70}
        )
        ...
        self.update_state(
            state="PROGRESS", meta={"status": "Uploading PDF to MinIO", "progress": 90}
        )
...
def cleanup_old_reports(self, max_age_hours: int = 24) -> Dict[str, Any]:
    ...
    try:
        ...
        self.update_state(
            state="PROGRESS",
            meta={
                "status": f"Deleting {len(objects_to_delete)} old reports",
                "progress": 50,
            },
        )
        ...
        self.update_state(
            state="PROGRESS",
            meta={
                "status": f"Cleanup completed, deleted {deleted_count} reports",
                "progress": 100,
            },
        )
...
def generate_dashboard_export(self, dashboard_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Upload file
        s3_client.put_object(
            Bucket=bucket_name, Key=filename, Body=content, ContentType=content_type
        )
