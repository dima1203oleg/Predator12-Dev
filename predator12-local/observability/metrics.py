...
# Cache Metrics
CACHE_HITS = Counter("cache_hits_total", "Total Cache Hits", ["cache_type"], namespace="predator")

CACHE_MISSES = Counter(
    "cache_misses_total", "Total Cache Misses", ["cache_type"], namespace="predator"
)

CACHE_SIZE = Gauge("cache_size_bytes", "Cache Size in Bytes", ["cache_type"], namespace="predator")
...
class RequestMetrics:
    ...
    def __exit__(
        ...
        REQUEST_COUNT.labels(method=self.method, endpoint=self.endpoint, status=status).inc()
