...
def build_agent_workflow():
    ...
    workflow.add_edge("agent", "tool", should_use_tool=lambda x: x["status"] == "fallback")
    workflow.add_edge("tool", "agent", should_retry=lambda x: x["status"] == "error")
...
if __name__ == "__main__":
    ...
    query_data = {"query": "Analyze tender collusion patterns", "session_id": "test_session"}
