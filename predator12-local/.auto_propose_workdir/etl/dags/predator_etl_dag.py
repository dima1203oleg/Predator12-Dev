...
extract_task = PythonOperator(
    task_id="extract_customs_data", python_callable=extract_customs_data, dag=dag
)

transform_task = PythonOperator(
    task_id="transform_customs_data", python_callable=transform_customs_data, dag=dag
)

load_task = PythonOperator(
    task_id="load_to_opensearch", python_callable=load_to_opensearch, dag=dag
)

anomaly_task = PythonOperator(
    task_id="trigger_anomaly_detection", python_callable=trigger_anomaly_detection, dag=dag
)
