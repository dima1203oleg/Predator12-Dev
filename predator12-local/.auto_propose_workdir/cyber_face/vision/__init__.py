...
class EmotionDetector:
    ...
    async def detect_emotions(
        self, frame: np.ndarray, face_landmarks: FaceLandmarks
    ) -> EmotionResult:
    ...
    async def _predict_with_opencv(
        self, face_roi: np.ndarray, landmarks: FaceLandmarks
    ) -> Dict[str, float]:
...
class AttentionTracker:
    ...
    async def _calculate_focus_level(
        self, gaze: Tuple[float, float], blink_rate: float, head_pose: Tuple[float, float, float]
    ) -> float:
