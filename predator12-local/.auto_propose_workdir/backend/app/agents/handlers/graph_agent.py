        ...
        try:
            ...
            if "betweenness" in centrality_types:
                ...
                for node_id in nodes:
                    ...
                    if neighbors:
                        avg_neighbor_degree = sum(nodes[n]["degree"] for n in neighbors) / len(
                            neighbors
                        )
        ...
        try:
                    ...
                    if node_id not in visited:
                        ...
                        if len(component) >= min_community_size:
                            communities[f"component_{component_id}"] = {
                                ...
                                "members": component,
                                "size": len(component),
                                "density": self._calculate_community_density(
            ...
            return {
                ...
                "statistics": {
                    ...
                    "avg_community_size": (
                        total_nodes_in_communities / len(communities) if communities else 0
                    ),
                },
            }
    ...
    async def _detect_patterns(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
                ...
                for i, node1 in enumerate(nodes):
                    for j, node2 in enumerate(nodes[i + 1 :], i + 1):
                        for k, node3 in enumerate(nodes[j + 1 :], j + 1):
                            if (
                                node2 in adjacency_list[node1]
                                and node3 in adjacency_list[node1]
                                and node3 in adjacency_list[node2]
                            ):
            ...
            if "stars" in pattern_types:
                ...
                patterns["stars"] = {"count": len(stars), "instances": stars[:10]}
            ...
            if "chains" in pattern_types:
                ...
                patterns["chains"] = {"count": len(chains), "instances": chains[:10]}
    ...
    async def _analyze_connectivity(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "components": [
                    {"id": i, "size": len(comp), "nodes": comp[:10]}  # Обмежуємо вивід
            ...
            for node_id, node_data in nodes.items():
                ...
                node_metrics[node_id] = {
                    ...
                    "anomaly_type": (
                        ...
                        else "low_degree" if z_score < -anomaly_threshold else "normal"
                    ),
                }
