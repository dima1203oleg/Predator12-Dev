...
class UserRequest(BaseModel):
    query: str = Field(..., min_length=3, max_length=1000, description="User query or command")
    channel: str = Field("api", regex="^(ui|telegram|api)$", description="Communication channel")
