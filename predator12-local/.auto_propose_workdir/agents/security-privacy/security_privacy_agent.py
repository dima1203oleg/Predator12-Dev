...
class SecurityPrivacyAgent:
    ...
    async def mask_pii(
        ...
        if isinstance(data, str):
            ...
            return {"original_type": "dict", "masked_data": masked_dict, "pii_found": pii_found}
            ...
            return {"original_type": "list", "masked_data": masked_list, "pii_found": pii_found}
    ...
    async def check_authorization(self, user_role: str, resource: str, action: str) -> bool:
        ...
        return (
            resource_action in permissions
            or resource_wildcard in permissions
