...
exports.VoiceControlInterface = void 0;
const react_1 = __importStar(require("react"));
const VoiceControlInterface = () => {
    ...
    const [currentTranscript, setCurrentTranscript] = (0, react_1.useState)('');
    ...
    const processVoiceCommand = (text) => {
        ...
        setTimeout(() => {
            ...
            setCommands(prev => prev.map(cmd => cmd.id === command.id
                ? Object.assign(Object.assign({}, cmd), { status: 'completed', result: result.message, agentTarget: result.agent }) : cmd));
        }, 1500);
    };
    ...
    return (<div style={{
      ...
      {isSupported ? (<div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '24px' }}>
          {/* Voice Controls */}
          <div>
            <div style={{
                display: 'flex',
            ...
            <div style={{ marginTop: '20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {exampleCommands.map((cmd, index) => (<div key={index} onClick={() => processVoiceCommand(cmd)} style={{
                    background: 'rgba(255, 255, 255, 0.05)',
                    border: '1px solid rgba(255, 255, 255, 0.1)',
                    borderRadius: '8px',
                    padding: '8px 12px',
          ...
          <div>
            ...
            <div style={{
              ...
              {commands.map((command) => (<div key={command.id} style={{
                    background: 'rgba(255, 255, 255, 0.05)',
                    border: '1px solid rgba(255, 255, 255, 0.1)',
                    borderRadius: '12px',
                    padding: '16px',
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '8px' }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ color: '#888', fontSize: '12px' }}>
                        ...
                        {command.agentTarget && (<span style={{ color: '#8B5CF6', marginLeft: '8px' }}>
                            → {command.agentTarget}
                          </span>)}
                      </div>
                    </div>
...
exports.VoiceControlInterface = VoiceControlInterface;
exports.default = exports.VoiceControlInterface;
