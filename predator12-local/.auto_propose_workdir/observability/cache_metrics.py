...
# Batch Metrics
BATCH_REQUESTS = Counter("batch_requests_total", "Total Batched Requests", ["agent_name", "status"])

BATCH_SIZE = Histogram(
    "batch_request_size", "Number of Requests in Batch", ["agent_name"], buckets=(1, 2, 5, 10, 20)
)

BATCH_LATENCY = Histogram("batch_latency_seconds", "Batch Processing Latency", ["agent_name"])
