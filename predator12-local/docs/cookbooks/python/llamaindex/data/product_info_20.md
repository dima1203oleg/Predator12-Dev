...
1. Ensure the control valve is in the "OFF" position.
1. Attach the fuel canister to the stove by following the manufacturer's instructions.
1. Verify that the fuel canister connection is secure.

1. Operating Instructions
1. Check that all connections are secure before operating the stove.
1. Open the fuel canister valve.
1. Light the stove using the provided ignition system or a long-reach lighter.
1. Adjust the flame intensity using the control valve.
1. Place your cookware on the stove's burner.
1. After use, turn off the control valve and close the fuel canister valve.
