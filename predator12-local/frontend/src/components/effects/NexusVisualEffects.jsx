...
exports.NexusVisualEffects = void 0;
// @ts-nocheck
const react_1 = __importDefault(require("react"));
const material_1 = require("@mui/material");
const system_1 = require("@mui/system");
// Keyframe animations
const float1 = (0, system_1.keyframes) `
  0% { transform: translate(0, 0) rotate(0deg); opacity: 0; }
  10% { opacity: 1; }
  90% { opacity: 1; }
  100% { transform: translate(-100px, -100px) rotate(360deg); opacity: 0; }
`;
const float2 = (0, system_1.keyframes) `
  0% { transform: translate(0, 0) rotate(0deg); opacity: 0; }
  10% { opacity: 1; }
  90% { opacity: 1; }
  100% { transform: translate(150px, -80px) rotate(-360deg); opacity: 0; }
`;
const float3 = (0, system_1.keyframes) `
  0% { transform: translate(0, 0) rotate(0deg); opacity: 0; }
  10% { opacity: 1; }
  90% { opacity: 1; }
  100% { transform: translate(-80px, 120px) rotate(180deg); opacity: 0; }
`;
const pulse = (0, system_1.keyframes) `
...
`;
const scanH = (0, system_1.keyframes) `
  0% { transform: translateX(-100%); }
  100% { transform: translateX(100vw); }
`;
const scanV = (0, system_1.keyframes) `
  0% { transform: translateY(-100%); }
  100% { transform: translateY(100vh); }
`;
const NexusVisualEffects = ({ showCosmicDust = true, showHolographicFrames = true, showScanLines = true }) => {
    const particles = [
    ...
    return (<>
      {/* Cosmic Dust */}
      {showCosmicDust && (<material_1.Box sx={{
                position: 'fixed',
                top: 0,
                left: 0,
                width: '100%',
          ...
          {particles.map((particle, index) => (<material_1.Box key={index} sx={{
                    position: 'absolute',
      ...
      {/* Holographic Frames */}
      {showHolographicFrames && (<material_1.Box sx={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 10 }}>
          {/* Top Left */}
          <material_1.Box sx={{
                position: 'fixed',
                top: 20,
      ...
      {/* Scan Lines */}
      {showScanLines && (<material_1.Box sx={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 5 }}>
...
exports.NexusVisualEffects = NexusVisualEffects;
exports.default = exports.NexusVisualEffects;
