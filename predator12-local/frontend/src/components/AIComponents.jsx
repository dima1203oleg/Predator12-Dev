...
exports.AIMetricsDashboard = exports.AgentControlPanel = exports.ModelComparisonTable = exports.TrainingPipelineCard = exports.AgentActivityTimeline = exports.AIStatsSummary = exports.ModelCard = exports.AgentCard = void 0;
...
// ============= AI STATS SUMMARY =============
const AIStatsSummary = ({ totalAgents, activeAgents, totalModels, totalRequests }) => {
    return (<div style={{
...
exports.AIStatsSummary = AIStatsSummary;
// ============= AGENT ACTIVITY TIMELINE =============
const AgentActivityTimeline = ({ activities }) => {
    const statusColors = {
        success: '#10B981',
        error: '#EF4444',
        info: '#3B82F6',
    ...
    return (<div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {activities.map((activity, index) => (<div key={index} style={{
                display: 'flex',
...
exports.AgentActivityTimeline = AgentActivityTimeline;
const TrainingPipelineCard = ({ pipeline }) => {
    const statusColors = {
        running: '#3B82F6',
        completed: '#10B981',
        failed: '#EF4444',
...
exports.TrainingPipelineCard = TrainingPipelineCard;
// ============= MODEL COMPARISON =============
const ModelComparisonTable = ({ models }) => {
    return (<div style={{
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        ...
        <tbody>
          {models.map((model) => (<tr key={model.id} style={{
...
exports.ModelComparisonTable = ModelComparisonTable;
// ============= AGENT CONTROL PANEL =============
const AgentControlPanel = ({ agent, onAction, }) => {
    const actions = [
    ...
    return (<div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
        {actions.map((action) => (<button key={action.id} onClick={() => onAction(action.id)} style={{
...
const AIMetricsDashboard = ({ totalRequests, avgLatency, successRate, activeModels }) => {
    const metrics = [
    ...
    return (<div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '24px' }}>
...
exports.AIMetricsDashboard = AIMetricsDashboard;
