...
const OpenSearchWrapper = ({ dashboardId, jwtToken }) => {
    ...
    return (_jsx("div", { style: { position: 'relative', border: '4px solid #0A75FF', borderRadius: 8, overflow: 'hidden' }, children: _jsx("iframe", { ref: iframeRef, src: src, style: { width: '100%', height: '100vh', border: 'none' }, allowFullScreen: true, title: "OpenSearch Dashboard" }) }));
};
