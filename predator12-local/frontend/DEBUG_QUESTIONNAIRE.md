...
Ваша відповідь: \***\*\*\*\*\***\*\*\***\*\*\*\*\***\_\_\_\***\*\*\*\*\***\*\*\***\*\*\*\*\***

### 2. Браузер

─────────────────────────────────────────────────────────────
ЧИ ВІДКРИЛИ ВИ БРАУЗЕР? (Так/Ні): **\*\***\_\_\_**\*\***

ЯКИЙ URL ВИКОРИСТОВУЄТЕ?
(наприклад: http://localhost:5092/): **\*\***\_\_\_**\*\***
...
[ ] F. Повідомлення про помилку (яке саме?) **\*\***\_\_\_**\*\***
[ ] G. test.html відкривається, але головна сторінка ні
[ ] H. Інше (опишіть): **\*\***\_\_\_**\*\***

### 4. Консоль Браузера (ДУЖЕ ВАЖЛИВО!)

─────────────────────────────────────────────────────────────
ЧИ ВІДКРИВАЛИ ВИ DEVELOPER TOOLS? (Так/Ні): **\*\***\_\_\_**\*\***
...
ЧИ Є ЧЕРВОНІ ПОМИЛКИ? (Так/Ні): **\*\***\_\_\_**\*\***
...
ЧИ Є ФАЙЛИ З ЧЕРВОНИМ СТАТУСОМ (404, 500)? (Так/Ні): **\*\***\_\_\_**\*\***
...
ЧИ ВІДКРИВАЄТЬСЯ test.html? (Так/Ні): **\*\***\_\_\_**\*\***
...
ЧИ БАЧИТЕ ВИ ТАКЕ ПОВІДОМЛЕННЯ? (Так/Ні): **\*\***\_\_\_**\*\***

ЯКИЙ ПОРТ ПОКАЗАНО В ТЕРМІНАЛІ? (наприклад 5092, 5093): **\*\***\_\_\_**\*\***
...
ЧИ ОТРИМАЛИ ВИ HTML КОД? (Так/Ні): **\*\***\_\_\_**\*\***
...
ЧИ ВСІ 3 ФАЙЛИ ІСНУЮТЬ? (Так/Ні): **\*\***\_\_\_**\*\***
