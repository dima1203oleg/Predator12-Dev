...
async def text_to_speech(request: TTSRequest):
    """🎤 Text-to-Speech з автоматичним fallback Пріоритет: Google Neural2 → AWS
    Polly Neural → Azure Neural → Local."""
...
async def speech_to_text(
    ...
    """🎧 Speech-to-Text з автоматичним fallback Рекомендація: використовуйте
    Browser Web Speech API для реального часу."""
