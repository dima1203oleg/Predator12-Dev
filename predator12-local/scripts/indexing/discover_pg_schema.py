...
class PostgreSQLSchemaDiscovery:
    ...
    async def get_table_structure(self, conn, schema: str, table: str) -> Dict[str, Any]:
    ...
    def generate_opensearch_mapping(
        self, columns: List[Dict[str, Any]], include_pii: bool = True
    ) -> Dict[str, Any]:
        ...
        for col in columns:
            ...
            if not include_pii and col_name.lower() in [
                f.lower() for f in self.detect_pii_fields(columns)
            ]:
    ...
    async def discover_all_schemas(self) -> Dict[str, Any]:
        ...
        try:
            ...
            discovery_result = {
                ...
                "tables": {},
                "mappings": {},
                "indexing_config": {"postgres": self.connection_params.copy(), "tables": {}},
            }
    ...
    async def save_discovery_results(self, results: Dict[str, Any], output_dir: str = "opensearch"):
        ...
        if yaml:
            ...
            with open(indexing_config_path, "w", encoding="utf-8") as f:
                yaml.dump(
                    results["indexing_config"], f, default_flow_style=False, allow_unicode=True
                )
...
async def main():
    ...
    parser.add_argument("--output-dir", default="opensearch", help="Output directory for results")
