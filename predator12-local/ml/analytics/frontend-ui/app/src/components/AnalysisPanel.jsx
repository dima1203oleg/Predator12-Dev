...
const AnalysisPanel = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            setTaskId(data.task_id || 'temp_id'); // Assuming task_id might not be returned, using a temp id
    ...
    return (
        <div className="p-6 bg-gray-900 text-white rounded-lg shadow-lg max-w-md mx-auto">
            <h2 className="text-2xl font-bold mb-4">Analysis Panel</h2>
            <textarea 
                ...
                placeholder="Enter your query for analysis..."
                rows={4}
                disabled={isLoading}
            />
            <button 
