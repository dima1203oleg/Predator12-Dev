...
async def update_notification_preferences(
    preferences: NotificationPreferences = Body(...), current_user: User = Depends(get_current_user)
):
    """
...
async def reset_notification_preferences(current_user: User = Depends(get_current_user)):
    """
