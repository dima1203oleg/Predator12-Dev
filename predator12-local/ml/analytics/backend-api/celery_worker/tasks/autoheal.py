...
def check_redis_connection():
    ...
    try:
        ...
        return {"status": "critical", "message": f"Redis connection failed: {str(e)}"}
...
def check_kafka_connection():
    ...
    try:
        ...
        return {"status": "warning", "message": f"Kafka connection failed: {str(e)}"}


def check_api_endpoints():
    """Check API endpoints."""
    try:
        endpoints = ["http://fastapi:8000/health", "http://fastapi:8000/metrics"]
        ...
        return {"status": "warning", "message": f"API check failed: {str(e)}"}
...
def check_cpu_usage():
    ...
    try:
        ...
        return {"status": status, "percent_used": cpu_percent, "cores": psutil.cpu_count()}
    except Exception as e:
        return {"status": "warning", "message": f"CPU check failed: {str(e)}"}
