...
# Database setup
engine = create_engine("postgresql://user:password@localhost:5432/predator_db")
                    ...
                    results.append(
                        {
                            ...
                            "confidence": 0.75,
                            "evidence": "Companies take turns winning tenders in " "this category",
                        }
                    )
                else:
                    results.append(
                    ...
                    results.append(
                        {
                            ...
                            "confidence": 0.79,
                            "evidence": "Favorable decisions made shortly " "after meetings",
                        }
                    )
        else:
